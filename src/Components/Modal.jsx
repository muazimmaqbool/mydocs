                ...
                <div class="w-full max-w-lg bg-white shadow-lg rounded-lg p-6 relative">
                    ...
                    <div class="border-t border-gray-300 pt-6 flex justify-end gap-4">
                        <button id="closeButton" type="button"
                            class="px-4 py-2 rounded-lg text-slate-900 text-sm font-medium border-none outline-none tracking-wide bg-gray-200 hover:bg-gray-300 active:bg-gray-200">Close</button>
                        <button type="button"
